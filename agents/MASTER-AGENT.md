...
| ORQUESTRAÇÃO | `/system/protocols/ORQUESTRACAO-PROTOCOL.md` |
| AGENT-COGNITION | `/agents/protocols/AGENT-COGNITION-PROTOCOL.md` |
| CONCLAVE | `/system/protocols/conclave/CONCLAVE-PROTOCOL.md` |
| DEBATE | `/system/protocols/conclave/DEBATE-PROTOCOL.md` |
| DEBATE-DYNAMICS | `/system/protocols/conclave/DEBATE-DYNAMICS-PROTOCOL.md` |
| DEBATE-CONFIG | `/system/protocols/conclave/DEBATE-DYNAMICS-CONFIG.yaml` |
...
> **Config completa:** `/system/protocols/council/DEBATE-DYNAMICS-CONFIG.yaml`
...
|-----------|-----------|------|
| **EPISTEMIC-PROTOCOL** | Anti-alucinação, honestidade, confidence levels | `/agents/protocols/EPISTEMIC-PROTOCOL.md` |
| **AGENT-INTERACTION** | Consultas diretas, handoffs, escalações | `/agents/protocols/AGENT-INTERACTION.md` |
| **WAR-ROOM** | Discussões multi-agente para decisões complexas | `/agents/protocols/WAR-ROOM.md` |
| **MEMORY-PROTOCOL** | Acumulação de conhecimento experiencial | `/agents/protocols/MEMORY-PROTOCOL.md` |
